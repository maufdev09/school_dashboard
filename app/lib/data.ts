...
export const calendarEvents = [
    // Wednesday - May 20
    {
        title: "Math",
        allDay: false,
        start: new Date(2026, 4, 20, 8, 0),
        end: new Date(2026, 4, 20, 8, 45),
    },
    {
        title: "English",
        allDay: false,
        start: new Date(2026, 4, 20, 9, 0),
        end: new Date(2026, 4, 20, 9, 45),
    },
    {
        title: "Physics",
        allDay: false,
        start: new Date(2026, 4, 20, 11, 0),
        end: new Date(2026, 4, 20, 11, 45),
    },
    {
        title: "History",
        allDay: false,
        start: new Date(2026, 4, 20, 14, 0),
        end: new Date(2026, 4, 20, 14, 45),
    },
    ...
    // Thursday - May 21
    {
        title: "Biology",
        allDay: false,
        start: new Date(2026, 4, 21, 8, 0),
        end: new Date(2026, 4, 21, 8, 45),
    },
    {
        title: "Chemistry",
        allDay: false,
        start: new Date(2026, 4, 21, 10, 0),
        end: new Date(2026, 4, 21, 10, 45),
    },
    {
        title: "English",
        allDay: false,
        start: new Date(2026, 4, 21, 13, 0),
        end: new Date(2026, 4, 21, 13, 45),
    },
    ...
    // Friday - May 22
    {
        ...
        end: new Date(2026, 4, 22, 9, 45),
    },
    {
        title: "Physics",
        allDay: false,
        start: new Date(2026, 4, 22, 11, 0),
        end: new Date(2026, 4, 22, 11, 45),
    },
    {
        title: "History",
        allDay: false,
        start: new Date(2026, 4, 22, 14, 0),
        end: new Date(2026, 4, 22, 14, 45),
    },
];